  ...
  return (
    <div className='p-6 bg-gray-100 flex flex-col gap-5'>
      ...
      <div className="min-h-screen flex justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-16 gap-6 w-full">
          
          <div className="lg:col-span-4 sm:col-span-2">
            <ProfileCard />
          </div>

          <div className="lg:col-span-7 sm:col-span-2 space-y-6">
            <AccountDetails />
            <AccountSecurity />
            <InviteFriends />
          </div>

          <div className="lg:col-span-5 sm:col-span-2 space-y-6">
            <AccountLevel />
            <FriendRequests />
          </div>
